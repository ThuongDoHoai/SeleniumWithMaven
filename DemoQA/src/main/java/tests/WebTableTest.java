...
public class WebTableTest extends TestCase {
	...
	public void registerNewAccountSuccessfully() throws InterruptedException {
		...
		String expectedResult = employee1.firstName + employee1.lastName + employee1.email + employee1.age
				+ employee1.salary + employee1.deparment;
		
		System.out.println(expectedResult);
		boolean check = webTablePage.checkLatestRecord(webTablePage.txtDataInRow, expectedResult);
